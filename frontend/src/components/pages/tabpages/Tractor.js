...
export default function Tractor() {
    ...
    const save = async ()=>{
        ...
        if(response.status == 201){
            ...
            tractors.push(data)
            setSeverity("success")
            setMessage("tractor has been added successfully")
            setOpen(true)
    ...
    const disabled = (errorRegistration | errorSerial | errorBrand | errorModel) ? true : false
    ...
    if(isForm){
        ...
        >
            <div>
                <TextInput required={true} id='registration' error={errorRegistration} label="Immatriculation du tracteur" callback={onChangeRegistration} value={registration} />
                <TextInput required={true} id='serial' error={errorSerial} label="Numéro de série" callback={onChangeSerial} value={serial} />
                <TextInput required={true} id='brand' error={errorBrand} label="Marque du tracteur" callback={onChangeBrand} value={brand} />
                <TextInput required={true} id='model' error={errorModel} label="Modèle du tracteur" callback={onChangeModel} value={model} />
            </div>
            <div>
        ...
        <>
            ...
            <FloatingActionButton callback={addTractor} />
        </>
        );
    }
